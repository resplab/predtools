...
calibration_plot(data = dev_data, obs = "y", pred_1 = "pred", title = "Calibration plot for development data")
calibration_plot(data = val_data, obs = "y_alt", pred_1 = "pred", y_lim = c(0, 0.6),
...
calibration_plot(data = val_data, obs = "y_alt", pred_1 = "pred_adj",
                 title = "Calibration plot for development data - after recalibration")
calibration_plot(data = val_data, obs = "y_alt", pred_1 = "pred", pred_2 = "pred_adj",
                 model_label_1 = "Premitive", model_label_2 = "Adjusted",
